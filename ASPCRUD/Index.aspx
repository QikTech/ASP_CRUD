        ...
        <div>
            ...
            <asp:GridView ID="gvProduct" runat="server" AutoGenerateColumns="false">
                <Columns>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                        <asp:LinkButton Text="Select" Id="linkSelect" CommandArgument='<% Eval("ProductId") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
...
//"FiretrekkersAppCon": "Data Source=127.0.0.1:3306; Initial Catalog=FiretrekkersDB; Integrated Security=true,User Id =root;password=cyb88"